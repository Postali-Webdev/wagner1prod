                    ...
                    <div class="featured-item">
                        ...
                        <div class="lower-row">
                            <?php if ($source === 'google') {
                                echo wp_get_attachment_image( '519', 'full', "", ["class" => "review-icon ignore-lazy"]);    
                            } else if( $source === 'avvo' ) {
                                echo wp_get_attachment_image( '1489', 'full', "", ["class" => "review-icon ignore-lazy"]);    
                            } ?>
                ...
                <?php while( have_posts() ) : the_post(); ?>
                    <div class="endorsement">
                        ...
                        <div class="lower-row">
                            ...
                            <?php if ($source == 'google') {
                                echo wp_get_attachment_image( '519', 'full', "", ["class" => "review-icon"]);    
                            } elseif( $source == 'avvo' ) {
                                echo wp_get_attachment_image( '1489', 'full', "", ["class" => "review-icon"]);    
                            } ?>
