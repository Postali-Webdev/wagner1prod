 ...
 */
    ...
    // load slider scripts
    wp_register_script('slick-ppc', '/wp-content/themes/postali-child/blocks/slider/slick-custom.js', array('jquery'), true);
    wp_enqueue_script('slick-ppc');
?>

<?php if ($slider_type == 'awards') { ?>

<section id="scroller-awards" style="background:<?php echo $slider_background_color; ?>">
    <div class="container">
        <div class="columns">
...
<section id="scroller-results" style="background:<?php echo $slider_background_color; ?>">
    <div class="container">
        <div class="columns">
...
<section id="scroller-testimonial" style="background:<?php echo $slider_background_color; ?>">
    <div class="container">
        <div class="columns">
            <h2><?php the_field('slider_section_headline'); ?></h2>  
            <div class="column-full block">                   
                <div class="slider-container">
                    ...
                    <img src="/wp-content/uploads/2024/04/google-review-bw-nobg.png" alt="Google Review logo" class="review-logo">
                </div>
            </div>
            <?php if (get_field('add_cta_block')) { ?>
            <div class="column-full">
...
<section id="scroller-attorney" style="background:<?php echo $slider_background_color; ?>">
    <div class="container">
        <div class="columns">
            <h2><?php the_field('slider_section_headline'); ?></h2>  
            <div class="column-full block">              
...
<section id="scroller-generic" style="background:<?php echo $slider_background_color; ?>">
    <div class="container">
        <div class="columns">
            <h2><?php the_field('slider_section_headline'); ?></h2>  
            <?php if(get_field('add_generic_image')) { ?>
            ...
            <div class="column-33">
                ...
                <?php 
                $image = get_field('generic_content_image');
                if( !empty( $image ) ): ?>
            ...
            <div class="column-full">
                <div class="spacer-30"></div>
                <div class="ppc-cta-block">
                    <a href="<?php echo $cta_button_link; ?>" class="btn"><?php echo $cta_button_text; ?></a><p><?php echo $cta_text; ?></p>
                </div>
                <div class="spacer-30"></div>
            </div>
            <?php } ?>
